                  ...
                  {delivery.paymentType === "cod" ? (
                    ...
                    <>
                      <div className="space-y-2">
                        <span className="text-[10px] uppercase font-bold text-zinc-500 tracking-wider">Payment Method</span>
                ...
                >
                  ...
                  <div className="border border-zinc-800 rounded-3xl overflow-hidden shadow-2xl bg-white text-zinc-900 p-6 relative">
                    ...
                    <div className="flex items-center justify-between border-b border-zinc-200 pb-4">
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          ...
                          <p className="text-zinc-400 text-[8px] uppercase tracking-wider font-bold block">
                            Official Payment Attestation
                          </p>
                        </div>
                      </div>
                      <div className="text-right">
                        <p className="text-[8px] uppercase tracking-wider text-zinc-400 font-bold">Receipt ID</p>
                    ...
                    <div className="mt-5 space-y-3.5 text-xs text-left">
                      <div className="rounded-xl bg-zinc-55 p-3 flex justify-between items-center">
                        <div>
                          <span className="text-[8px] uppercase tracking-wider text-zinc-450 block font-bold">Payment Method</span>
                        ...
                        <div className="text-right">
                          <span className="text-[8px] uppercase tracking-wider text-zinc-450 block font-bold">Transaction Reference</span>
                      ...
                      <div className="grid grid-cols-2 gap-3.5">
                        <div className="rounded-xl bg-zinc-55 p-2.5">
                          <span className="text-[8px] uppercase tracking-wider text-zinc-450 block font-bold">Customer Name</span>
                          <span className="text-zinc-950 font-bold block truncate">{delivery.customer}</span>
                        </div>
                        <div className="rounded-xl bg-zinc-55 p-2.5">
                          <span className="text-[8px] uppercase tracking-wider text-zinc-450 block font-bold">Payment Date</span>
                      ...
                      <div className="rounded-xl bg-zinc-55 p-3 flex justify-between items-center">
                        <div>
                          <span className="text-[8px] uppercase tracking-wider text-zinc-450 block font-bold">Billing Total</span>
                    ...
                    <div className="border-t border-zinc-200 mt-6 pt-4 flex items-center justify-between text-left">
                      <div>
                        <p className="text-[8px] uppercase tracking-wider text-zinc-450 font-bold">Attestation Network</p>
